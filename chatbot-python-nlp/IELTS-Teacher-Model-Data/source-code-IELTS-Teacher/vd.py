...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        # head label
        head_label = Label(self.window, bg=BG_COLOR, fg="yellow",text="Welcome To Chat With Sin", font=FONT_BOLD, pady=10)
        head_label.place(relwidth=1)
        # mic
        mic_button = Button(head_label, text="V", font=FONT_BOLD, bg=BG_GRAY, fg="black", bd=0, width=4, height=4,command=lambda: self._on_mic_button_pressed())
        mic_button.place(relx=0.955, rely=0.5, anchor="center")
        # Guide
        ask_button = Button(head_label, text="?", font=FONT_BOLD, bg=BG_GRAY, fg="black", bd=0, width=4, height=4,command=lambda: self.show_guide())
